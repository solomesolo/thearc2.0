...
const steps = [
  "Begin free screening to identify missing essential tests",
  "Upload past labwork to reconstruct baseline",
  "Receive first stabilisation tasks within 48 hours",
  "Access your unified medical file for ongoing recovery tracking",
];

export function RebuilderNextSteps() {
  return (
